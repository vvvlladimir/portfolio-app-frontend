...
import {ChartAreaInteractive} from "@/shared/components/widgets/chart-area-interactive";
  ...
  return (
      <main>
        ...
        <div className="p-4 space-y-4">
          <div className="grid gap-4
            ...
            <Card className="@container/card p-4">
              <div className="flex items-center justify-between">
                ...
                <HoverCard>
                  <HoverCardTrigger>
                    <ReturnBadge value={totalChangePercent}/>
                  </HoverCardTrigger>
            ...
            <Card className="@container/card p-4">
              <div className="flex items-center justify-between">
                ...
                <ReturnBadge value={(lastValue?.total_pnl_pct || 0) + totalChangePercent}/>
              </div>
          ...
          {
            portfolio?.history && (
                  <ChartAreaInteractive chartData={portfolio?.history}
